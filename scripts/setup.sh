...

{
  ...
  echo "# Split tunnel: routes only VPN subnet + server subnet through the Pi."
  echo "# Change 192.168.50.0/24 to match your server subnet if needed."
  echo "# Use 0.0.0.0/0 for full tunnel (all traffic through Pi)."
  echo "WG_ALLOWED_IPS='10.8.0.0/24,192.168.50.0/24'"
